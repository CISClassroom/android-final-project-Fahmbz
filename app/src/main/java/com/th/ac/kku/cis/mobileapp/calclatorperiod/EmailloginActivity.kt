...
class EmailloginActivity : AppCompatActivity() {
    ...
    public override fun onCreate(savedInstanceState: Bundle?) {
        ...
        _loginButton = findViewById(R.id.button_email) as Button
       // _signupLink = findViewById(R.id.registertext) as TextView
        _passwordText = findViewById(R.id.password) as EditText
        _emailText = findViewById(R.id.userandemail) as EditText
